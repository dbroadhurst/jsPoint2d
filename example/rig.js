var rig = (function() {
  ...
  function rotateRig() {
    var r = 0,
      ...
      ctx = htmlCanvas.getContext('2d'),
      matScale = new jsMatrix2d().identity(),
      matTranslate = new jsMatrix2d().identity(),
      mat = new jsMatrix2d().identity(),
      shape = [
							[-64, -64],
							[64, -64],
  ...
  function srt() {
    var s = 0,
      ...
      ctx = htmlCanvas.getContext('2d'),
      matScale = new jsMatrix2d().identity(),
      matRotate = new jsMatrix2d().identity(),
      matTranslate = new jsMatrix2d().identity(),
      mat = new jsMatrix2d().identity(),
      shape = [
							[-64, -64],
  ...
  function drawShape(ctx, shape, mat) {
    ...
    ctx.lineWidth = 2;
    ctx.beginPath();
    p1 = new jsPoint2d(0, 0);
    p2 = new jsPoint2d(0, 0);

    // draw shape
    for (i = 0; i < shape.length; i += 1) {
      p1.init(shape[i][0], shape[i][1]);
